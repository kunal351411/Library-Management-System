...
describe('BookComponent', () => {
  ...
  it('should render book card when clickedBookId is null', () => {
    ...
    const bookCard = fixture.debugElement.query(
      By.css('[data-testid="book-card"]')
    );
    expect(bookCard).toBeTruthy();

    const bookDetails = fixture.debugElement.query(
      By.css('[data-testid="book-details"]')
    );
  ...
  it('should delete book when onDeleteBook is called', () => {
    ...
    expect(fakeBooksService.deleteBook).toHaveBeenCalledWith(
      component.bookCardInfo.id
    );
    expect(fakeSnackbarService.openSnackBar).toHaveBeenCalledWith(
  ...
  it('should have required error message for touched empty name field in form', () => {
    ...
    const requiredNameErrorMessage = fixture.debugElement.query(
      By.css('[data-testid="name-required"]')
    );
  ...
  it('should have required error message for touched empty author field in form', () => {
    ...
    const requiredAuthorErrorMessage = fixture.debugElement.query(
      By.css('[data-testid="author-required"]')
    );
  ...
  it('should have required error message for touched empty price field in form', () => {
    ...
    const requiredPriceErrorMessage = fixture.debugElement.query(
      By.css('[data-testid="price-required"]')
    );
