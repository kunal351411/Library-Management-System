...
describe('BooksComponent', () => {
  ...
  it('should have submit button disabled until form gets valid', () => {
    ...
    component.bookForm.controls['name'].setValue(VALID_BOOK_DATA.name);
    component.bookForm.controls['author'].setValue(VALID_BOOK_DATA.author);
    component.bookForm.controls['price'].setValue(VALID_BOOK_DATA.price);
    fixture.detectChanges();
