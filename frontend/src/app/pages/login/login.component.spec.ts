...
describe('LoginComponent', () => {
  ...
  it('should be able to submit successfully', () => {
    ...
    component.loginForm.controls['email'].setValue(VALID_DATA.email);
    component.loginForm.controls['password'].setValue(VALID_DATA.password);
    fixture.detectChanges();
  ...
  it('should call login() of Auth Service when submitted', () => {
    ...
    expect(fakeAuthService.login).toHaveBeenCalledWith(VALID_DATA);
  });
  ...
  it('should not have error message for valid email', () => {
    ...
    const invalidEmailErrorMessage = fixture.debugElement.query(
      By.css('[data-testid="email-invalid"]')
    );
    expect(invalidEmailErrorMessage).toBeFalsy();

    const requiredEmailErrorMessage = fixture.debugElement.query(
      By.css('[data-testid="email-required"]')
    );
  ...
  it('should have required error message for touched empty password field', () => {
    ...
    const requiredEmailErrorMessage = fixture.debugElement.query(
      By.css('[data-testid="password-required"]')
    );
    expect(requiredEmailErrorMessage).toBeTruthy();
  });
